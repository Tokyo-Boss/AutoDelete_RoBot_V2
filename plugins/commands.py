...
async def start(client, message):
    ...
    await client.send_cached_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('⭕☞ 𝙅𝙊𝙄𝙉 𝙈𝘼𝙄𝙉 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 ⭕', url="https://t.me/tmmainchannel")
                ],
                [
                    InlineKeyboardButton('⭕☞ 𝙅𝙊𝙄𝙉 𝙈𝙊𝙑𝙄𝙀𝙎 𝙂𝙍𝙊𝙐𝙋 ⭕', url="https://t.me/technomoviescollection")
                ],
                [
                    InlineKeyboardButton('⭕☞ 𝙅𝙊𝙄𝙉 𝘾𝙃𝘼𝙏𝙏𝙄𝙉𝙂 𝙂𝙍𝙊𝙐𝙋 ⭕', url="https://t.me/Technomindzchat")
                ]
            ]
        )
    )
